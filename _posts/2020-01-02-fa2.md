...
Identified firms whose Sharpe ratio is at the min, 50 and max quantile, respectively. Created a table to summarize these Sharpe ratios. In addition, for each of these firms, summarized the sample length, the starting date and the ending date.
