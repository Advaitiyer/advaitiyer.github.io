...
**Forecasts:** The Monte Carlo simulation and the Neural Network under the following settings provides the best possible profit estimates for various states as follows:
